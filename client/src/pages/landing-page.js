            ...
            <div className="text-color home">
                <div className="home-hero">
                    <div className="hero-card">
                        <p className="text-regular-18">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                ...
                <div className="item-display">
                    ...
                    <div className="item-carousel">
                        <p className="text-medium-24 title">Kitchen Supplies/Ustensils</p>
                        <div className="item-wrapper">
                            <div className="item-card-c">
                                <div className="item-pic" style={{backgroundImage: "url(/images/cup4.jpg)"}}></div>
                            ...
                            <div className="item-card-c">
                                <div className="item-pic" style={{backgroundImage: "url(/images/cup.jpg)"}}></div>
                    ...
                    <div className="item-carousel">
                        <p className="text-medium-24 title">Furniture</p>
                        <div className="item-wrapper">
                            <div className="item-card-c">
                                <div className="item-pic" style={{backgroundImage: "url(/images/cup4.jpg)"}}></div>
                    ...
                    <div className="item-carousel">
                        <p className="text-medium-24 title">Decorations</p>
                        <div className="item-wrapper">
                            <div className="item-card-c">
                                <div className="item-pic" style={{backgroundImage: "url(/images/cup4.jpg)"}}></div>
