                    ...
                    <form onSubmit={this.saveProduct}>
                        {/* <div className="dropzone">
                            ...
                            <div class="upload-btn-wrapper">
                                ...
                                <input type="file" name="file" value={img} onChange={(e) => setImg(e.target.value)} />
                            </div>
                        </div> */}
                        <FileBase64

                            multiple={false}
                            onDone={({ file }) => this.setState({ img: { image: file.toString('base64'), title: this.state.title + Date.now() } })} />
